...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const GOOGLE_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLScmVTZnb4pzlqhB-e39CWZkEeuBx1sj392AzGjkLQyXS3TuyA/viewform';
  ...
  function submitToGoogleForm() {
    ...
    // フォームを送信（実際の環境ではここでGoogleフォームへのPOSTが必要）
    setTimeout(function() {
